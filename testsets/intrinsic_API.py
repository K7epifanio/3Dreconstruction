...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Camera_Calibration_API. Saves the calibration results in a pickle file \n NOTE: USE THE API AS IMPORTABLE MODULE FOR ADDED CONTROL",
        formatter_class=RawTextHelpFormatter)
    parser.add_argument("--images_dir", help="Path to the directory containing calibration images (no / in end)",
                        type=str, metavar='', default=None)
    parser.add_argument("-pt", "--pattern_type", help="The pattern type for calibration", type=str, metavar='',
                        default=None)
    ...
    parser.add_argument("-d", "--distance", help="The distance between points in world units", type=float, metavar='',
                        default=1.0)
    ...
    parser.add_argument("-ch", "--cam_height", help="height of cam for visualization", type=float, metavar='',
                        default=0.5)
    parser.add_argument("--save", help="path to save the results as a pickle file", type=str, metavar='',
    ...
    assert args.pattern_type in pattern_types, "The --pattern_type must be one of {}. 'custom' pattern is not supported in terminal mode".format(
        pattern_types)
